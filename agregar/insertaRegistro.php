...
<body background="http://www.agvarelapru.esy.es/FORMULARIO-1/fondo.jpg" Style="font-family:Calibri;">
    
        <div Style=" background-color: lightgray;margin-top:20px;padding-top: 10px; padding-bottom: 10px; padding-right: 5%; padding-left: 5%; width: 80%;  border-radius: 25px;  margin-left:5%; margin-right:5%;">
